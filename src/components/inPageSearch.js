...
class Search extends React.Component{
  ...
  render(){
    ...
    const searchButtonTitle = (this.state.category == "") ? odaberiteKategorijuText : "Pretražite nekretnine!";
      ...
      <div>
        <div className="sidebar_search_form_container">
          <form action="#" className="sidebar_search_form" id="sidebar_search_form">
            <select style={downImgStyle}  className="sidebar_search_select" name="category" onChange={this.handleChangeCategory} value={this.props.searchQuery.category}>
              <option value="">Category</option>
              {categories}
            </select>
            <select style={downImgStyle} disabled={disabled} className="sidebar_search_select" name="location" onChange={this.handleInputChange} value={this.props.searchQuery.location}>
            ...
            <div className="area_filter">
              <section className="range-slider2">
            ...
            <button type="button" className="sidebar_search_button" disabled={disabled} title={searchButtonTitle} onClick={this.handleSubmit}><Link to="/nekretnine">Search</Link></button>
          </form>
        </div>
      </div>
    )
