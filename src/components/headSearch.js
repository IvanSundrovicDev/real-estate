            ...
            <div className="home_search_container">
              <div className="home_search_content">
                <form action="#" className="search_form d-flex flex-row align-items-start justfy-content-start">
                  ...
                  <Link to="/nekretnine" className="fix-height">
                    <button id="submitButton" type="button" className="search_form_button ml-auto" disabled={disabled} title={searchButtonTitle} onClick={this.handleSubmit}>Search</button>
                  </Link>
                </form>
              </div>
            </div>
...
export default connect(mapStateToProps, matchDispatchToProps)(HeadSearch)
